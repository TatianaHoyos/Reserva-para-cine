...
class FuntionRepository:
    ...
    def insert_funtion(self):
        ...
        funtion = [
            ...
            {"id": 7, "movie_id": 1, "room_id": 3, "date": "20/05/2024", "hora": "6:00 p.m"},
            {"id": 8, "movie_id": 1, "room_id": 3, "date": "20/05/2024", "hora": "8:00 p.m"},
            {"id": 9, "movie_id": 1, "room_id": 3, "date": "20/05/2024", "hora": "10:00 p.m"}
            ]
